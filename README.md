...
GasLockR is the first trustless GasFi protocol. It leverages ZK proofs for trustless reading of historical gas prices and pricing models to build on-chain derivatives based on gas prices.
